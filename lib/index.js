...
class BilibiliApi {
    constructor({ cookie, ua, host }) {
        this.host = host || 'https://api.bilibili.com'
        this.ua = ua || 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36'
        this.cookie = cookie
        this.jct = ''
    }
